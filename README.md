...
* [ ] Verify that you have LESS installed correctly by running `lessc -v` in your terminal, if you don't get a version message back, reach out to your project manager for help. * Used Sass since Less wouldn't download properly* [removed and updated NPM and Node.js]
